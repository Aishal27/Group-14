      ...
      <Image 
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            ...
            <p><h5>University for Women: University with a change</h5></p>
          </div>
        </div>
      </div>
      ...
      <Image 
        ...
        <div class="container">
          <div class="carousel-caption">
            ...
            <p><h5>-Mahatma Gandhi(1946)</h5></p>
            <p><h5 className="text-warning">Banasthali Vidyapith, established in 1935, is the world's largest residential university for women, doing 
              pioneering work in its field for more than eight decades. Only of its kind origin: The 'Banasthali story' has no 
              parallel across the globe.</h5></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
      <Image 
        ...
        <div class="container">
          <div class="carousel-caption text-end">
            <h1 className="text-center text-info">"If I had been a girl I would have come to Banasthali for my education"</h1>
            <p><h5>-Pandit Nehru (1945)</h5></p>
          </div>
        </div>
      </div>
    </div>
