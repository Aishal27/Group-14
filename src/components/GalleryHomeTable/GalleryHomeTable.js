...
<div class="card text-white bg-info mb-3">
      ...
      <div class="card-body">
      <div>
        The campus has quality infrastructure for games and sports programmes.
        The <i className="pb-2 text-dark">Laxmi Bai maidan</i> (26,690 sq.
        meters) is used for activities such as parade and annual fairs. It also
        has a stage and projection room for regular cultural programmes and film
        shows. The <i className="pb-2 text-dark">Vidula Maidan</i> (41,950
        sq. meters) has fields for games such as hockey, volleyball, basket
        ball, tennis, yoga, martial arts and mass physical display activities.
        Adequate space for indoor games such as badminton and table tennis is
        also available. The swimming pool is open for students, staff members
        and their families. Another unique activity carried on since long is
        horse riding for which there are 41 horses and a field called{" "}
        <i className="pb-2 text-dark">‘Veer Bala Maidan’</i> (25,390 sq.
        meters). The infrastructure for games and sports is continuously
        upgraded in terms of quality and facilities. The Vidyapith has a Cricket
        Ground inaugurated as{" "}
      ...
      <div>
        ...
        students and staff of Banasthali. It operates at 90.4 MHz and serves the
        campus and the community within a radius of 30 km around Banasthali.
      </div>
</div>
</div>
          <br />
      ...
      <div class="card-body">
          ...
          <br />
          <i className="pb-2 text-light">Besides these facilities, the following amenities are available at the campus:</i>
